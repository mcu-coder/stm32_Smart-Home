...
void userHandle(void)
{
    ...
    currentDataPoint.valuehPa = 1020;//Add Sensor Data Collection
    currentDataPoint.valuesmoke = sensorData.smoke;//Add Sensor Data Collection
    currentDataPoint.valueCO = sensorData.CO;//Add Sensor Data Collection
    currentDataPoint.valueAQI = sensorData.AQI;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    currentDataPoint.valuewindow = 0;
    currentDataPoint.valuebuzzer = 0;
    currentDataPoint.valuemodel = 0;
    currentDataPoint.valuetemperature = 0;
    currentDataPoint.valuehumidness = 0;
    currentDataPoint.valuelux = 0;
    currentDataPoint.valuehPa = 1020;
    currentDataPoint.valuesmoke = 0;
    currentDataPoint.valueCO = 0;
    currentDataPoint.valueAQI = 0;
