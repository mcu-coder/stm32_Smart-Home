...
#define MOTOR1_PROT GPIOB

#define MOTOR_C GPIO_Pin_15
#define MOTOR_D GPIO_Pin_12
#define MOTOR2_PROT GPIOA
...
#define MOTOR_D_HIGH GPIO_SetBits(MOTOR2_PROT,MOTOR_D)
#define MOTOR_D_LOW GPIO_ResetBits(MOTOR2_PROT,MOTOR_D)
